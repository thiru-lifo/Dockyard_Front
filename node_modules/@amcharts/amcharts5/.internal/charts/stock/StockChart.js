                ...
                if (stockSeries && stockSeries.isType("BaseColumnSeries")) {
                    ...
                    $array.each(stockSeries.dataItems, function (dataItem) {
                        ...
                        if (column) {
                            ...
                            var dropFromPrevious = column.states.lookup("dropFromPrevious");
                            if (dropFromPrevious) {
                                dropFromPrevious.setAll({ fill: stockNegativeColor_1, stroke: stockNegativeColor_1 });
                            }
                            var riseFromPrevious = column.states.lookup("riseFromPrevious");
                            if (riseFromPrevious) {
                                riseFromPrevious.setAll({ fill: stockPositiveColor_1, stroke: stockPositiveColor_1 });
                            }
                            stockSeries._applyGraphicsStates(dataItem, previous_2);
                            previous_2 = dataItem;
                        }
                    });
                    stockSeries.columns.template.states.create("riseFromOpen", { fill: stockPositiveColor_1, stroke: stockPositiveColor_1 });
                    stockSeries.columns.template.states.create("riseFromPrevious", { fill: stockPositiveColor_1, stroke: stockPositiveColor_1 });
                    stockSeries.columns.template.states.create("dropFromOpen", { fill: stockNegativeColor_1, stroke: stockNegativeColor_1 });
                    stockSeries.columns.template.states.create("dropFromPrevious", { fill: stockNegativeColor_1, stroke: stockNegativeColor_1 });
