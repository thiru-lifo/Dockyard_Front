 ...
 */
var SeriesTypeControl = /** @class */ (function (_super) {
    __extends(SeriesTypeControl, _super);
    function SeriesTypeControl() {
    ...
    return SeriesTypeControl;
}(DropdownListControl));
export { SeriesTypeControl };
