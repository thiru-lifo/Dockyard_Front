            ...
            if (chart) {
                var _loop_1 = function (i) {
                    ...
                    if (line) {
                        ...
                        if (p1_1 && p2_1) {
                            var dy = (p2_1.y - p1_1.y) / 4;
                            var m1y_1 = p1_1.y + dy;
                            var m2y_1 = p1_1.y + dy * 2;
                            var m3y_1 = p1_1.y + dy * 3;
                            line.set("draw", function (display) {
                                display.moveTo(p1_1.x, p1_1.y);
                                display.lineTo(p2_1.x, p1_1.y);
                                display.moveTo(p1_1.x, m1y_1);
                                display.lineTo(p2_1.x, m1y_1);
                                display.moveTo(p1_1.x, m2y_1);
                                display.lineTo(p2_1.x, m2y_1);
                                display.moveTo(p1_1.x, m3y_1);
                                display.lineTo(p2_1.x, m3y_1);
                                display.moveTo(p1_1.x, p2_1.y);
                                display.lineTo(p2_1.x, p2_1.y);
                            });
                            fill1.set("draw", function (display) {
                                display.moveTo(p1_1.x, p1_1.y);
                                display.lineTo(p2_1.x, p1_1.y);
                                display.lineTo(p2_1.x, p2_1.y);
                                display.lineTo(p1_1.x, p2_1.y);
                                display.lineTo(p1_1.x, p1_1.y);
                            });
                            fill2.set("draw", function (display) {
                                display.moveTo(p1_1.x, m1y_1);
                                display.lineTo(p2_1.x, m1y_1);
                                display.lineTo(p2_1.x, m3y_1);
                                display.lineTo(p1_1.x, m3y_1);
                                display.lineTo(p1_1.x, m1y_1);
                            });
                        }
                    }
                };
