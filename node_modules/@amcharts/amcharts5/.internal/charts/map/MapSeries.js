...
var MapSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(MapSeries.prototype, "_parseGeoJSON", {
        ...
        value: function () {
            ...
            if (geoJSON) {
                ...
                if (features) {
                    var idField = this.get("idField", "id");
                    var _loop_1 = function (i, len) {
                        var feature = features[i];
                        var geometry = feature.geometry;
                        if (geometry) {
                            var type_1 = geometry.type;
                            var id_1 = feature[idField];
                            ...
                            if (this_1._types.indexOf(type_1) != -1) {
                                ...
                                if (!dataItem) {
                                    dataObject = { geometry: geometry, geometryType: type_1, madeFromGeoData: true };
                                    dataObject[idField] = id_1;
    ...
    Object.defineProperty(MapSeries.prototype, "_addGeometry", {
        ...
        configurable: true,
        writable: true,
        value: function (geometry, series) {
