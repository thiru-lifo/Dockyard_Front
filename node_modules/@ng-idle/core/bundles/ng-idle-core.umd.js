(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ng-idle/core', ['exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['ng-idle'] = global['ng-idle'] || {}, global['ng-idle'].core = {}), global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var Interrupt = /** @class */ (function () {
        function Interrupt(source, options) {
            this.source = source;
        ...
        Idle.prototype.setInterrupts = function (sources) {
            ...
            try {
                for (var sources_1 = __values(sources), sources_1_1 = sources_1.next(); !sources_1_1.done; sources_1_1 = sources_1.next()) {
                    ...
                    var options = { platformId: this.platformId };
                    var sub = new Interrupt(source, options);
    ...
    var EventTargetInterruptSource = /** @class */ (function (_super) {
        ...
        function EventTargetInterruptSource(target, events, opts) {
            var _this = _super.call(this, null, null) || this;
            _this.target = target;
            _this.events = events;
            _this.opts = opts;
            _this.eventSubscription = new rxjs.Subscription();
            if (typeof _this.opts === 'number') {
                _this.opts = { throttleDelay: _this.opts, passive: false };
            }
            _this.opts = _this.opts || {
                passive: false,
                throttleDelay: defaultThrottleDelay
            };
            if (_this.opts.throttleDelay === undefined || _this.opts.throttleDelay === null) {
                _this.opts.throttleDelay = defaultThrottleDelay;
            }
            _this.throttleDelay = _this.opts.throttleDelay;
            _this.passive = !!_this.opts.passive;
            return _this;
        }
        EventTargetInterruptSource.prototype.initialize = function (options) {
            var _this = this;
            if ((options === null || options === void 0 ? void 0 : options.platformId) && common.isPlatformServer(options.platformId)) {
                return;
            }
            var eventTarget = typeof this.target === 'function' ? this.target() : this.target;
            var opts = this.passive ? { passive: true } : null;
            var fromEvents = this.events
                .split(' ')
                .map(function (eventName) { return rxjs.fromEvent(eventTarget, eventName, opts); });
            this.eventSrc = rxjs.merge.apply(void 0, __spreadArray([], __read(fromEvents)));
            this.eventSrc = this.eventSrc.pipe(operators.filter(function (innerArgs) { return !_this.filterEvent(innerArgs); }));
            if (this.throttleDelay > 0) {
                this.eventSrc = this.eventSrc.pipe(operators.throttleTime(this.throttleDelay));
            }
            var handler = function (innerArgs) { return _this.onInterrupt.emit(new InterruptArgs(_this, innerArgs)); };
            this.attachFn = function () { return (_this.eventSubscription = _this.eventSrc.subscribe(handler)); };
            this.detachFn = function () { return _this.eventSubscription.unsubscribe(); };
        };
        /*
    ...
    var DocumentInterruptSource = /** @class */ (function (_super) {
        ...
        function DocumentInterruptSource(events, options) {
            return _super.call(this, function () { return document.documentElement; }, events, options) || this;
        }
        /*
    ...
    var WindowInterruptSource = /** @class */ (function (_super) {
        ...
        function WindowInterruptSource(events, options) {
            return _super.call(this, function () { return window; }, events, options) || this;
        }
    ...
    var StorageInterruptSource = /** @class */ (function (_super) {
        ...
        function StorageInterruptSource(options) {
            if (options === void 0) { options = 500; }
            return _super.call(this, 'storage', options) || this;
        }
        /*
         * Checks to see if the event should be filtered.
         * @param event - The original event object.
