...
editorConfig2: AngularEditorConfig = {
  ...
  getListing() {
    this.api
      .getAPI(environment.API_URL + "transaction/psr/receipt_of_rfi_responses?approved_status=2")
      .subscribe((res) => {
  ...
  getListing1()
  {
    ...
    console.log(this.dataListPending,'dasda')
    this.dataSourcePending.paginator = this.paginationPending;
  }
  ...
  disableDate(){
   ...
   downloadFile(file_name){
    //alert(file_name)
    //let url = environment.API_URL + file_name;
