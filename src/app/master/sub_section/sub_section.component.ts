...
export class SubSectionComponent implements OnInit {
  ...
  getSubSection() {
    ...
    this.api
      .getAPI(environment.API_URL + "master/sub_section?"+this.param)
      .subscribe((res) => {
  ...
  onDelete(id) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if(result) {
        this.api.postAPI(environment.API_URL + "master/sub_section/details", {
          id: id,
          status: 3,
        }).subscribe((res)=>{
          this.logger.log('response',res);
  ...
  onSubmit() {
     if (this.editForm.valid) {
      ...
      this.api
        .postAPI(
          environment.API_URL + "master/sub_section/details",
          this.editForm.value
        )
        .subscribe((res) => {
          this.logger.log('response',res);
