...
const routes: Routes = [
  { path: '', component: ConfigComponent, data: { breadcrumb: 'General'} },
  { path: 'general', component : ConfigComponent, data: { breadcrumb: 'General'} },
  { path: 'approval', component : ApprovalComponent, data: { breadcrumb: 'Approval'} },
