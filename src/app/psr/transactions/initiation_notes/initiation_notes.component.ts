...
@Component({
  ...
  templateUrl: './initiation_notes.component.html',
  styleUrls: ['./initiation_notes.component.scss']
})
export class InitiationNotesComponent implements OnInit {
  ...
  getProject() {
    this.api
      .getAPI(environment.API_URL + "master/project")
      .subscribe((res) => {
