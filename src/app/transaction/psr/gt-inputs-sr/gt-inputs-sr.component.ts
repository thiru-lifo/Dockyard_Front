...
@Component({
  selector: 'app-gt-inputs-sr',
  templateUrl: './gt-inputs-sr.component.html',
  styleUrls: ['./gt-inputs-sr.component.scss']
})
export class GTInputsSRComponent implements OnInit {
  ...
  populate(data) {
    ...
    this.global_psr1 = data['sub_module'][3]['section']
...
//   };
  ...
  internalMapping(project_id=''){
    ...
    this.api
    .postAPI(environment.API_URL + "transaction/forms-template",{"module_id":1,"form_id":4,"project_id":project_id})
      .subscribe((res) => {
...
getProject(code) {
  this.api
    .getAPI(environment.API_URL + "transaction/global_transaction_edit_1?approved_status=2&sub_module_id=2")
    .subscribe((res) => {
...
for (var i = 0; i < res.data.length; ++i) {
  ...
  for (var j = 0; j < this.dataListPending.length; ++j) {
     console.log('project1',this.dataListPending[j].project)
...
console.log(this.FinalArray,'dsdd');
  ...
  getListing() {
    this.api
    .getAPI(environment.API_URL + "transaction/global_transaction_edit_1?module_id=1&sub_module_id=4")
      .subscribe((res) => {
...
editt:any;
  ...
  editOption(initiation) {
    ...
    this.global_psr1 = initiation['sub_module'][3]['section']
    ...
    if (this.editFormApproval.valid) {
      ...
      .subscribe((res) => {
        ...
        if(res.status==environment.SUCCESS_CODE){
          ...
          this.getListing();
          this.notification.warn('PSR Input For Staff Requirements Updated');
  ...
  onSubmit(type='') {
    ...
    //return false;
     ...
     //if (this.editForm.valid) {
      ...
      console.log(this.input_sr,"YYYYYYYYYy")
      this.api
        .postAPI(
