...
@Component({
  ...
  templateUrl: './gt-concept-design.component.html',
  styleUrls: ['./gt-concept-design.component.scss']
})
export class GTConceptDesignComponent implements OnInit {
  ...
  checkValue()
  {
    console.log("this.concept_design",this.concept_design)
  ...
  checkValueMapping()
  {
    console.log("this.input_sr_mapping",this.input_sr_mapping)
  ...
  populate(data) {
    ...
    this.global_psr1 = data['sub_module'][4]['section']
...
//   };
  ...
  if(project_id!=""){
    ...
    this.api
    .postAPI(environment.API_URL + "transaction/forms-template",{"module_id":1,"form_id":5,"project_id":project_id})
      .subscribe((res) => {
...
getProject(code) {
  this.api
    .getAPI(environment.API_URL + "transaction/global_transaction_edit_1?approved_status=2&sub_module_id=4")
    .subscribe((res) => {
      //console.log('dff',res.data[0].project)
if(code=="add"){
for (var i = 0; i < res.data.length; ++i) {
   res.data[i].project;
   console.log('project1',res.data[i].project)
  var found = false;
...
console.log(this.FinalArray,'dsdd');
  ...
  getListing() {
    this.api
    .getAPI(environment.API_URL + "transaction/global_transaction_edit_1?module_id=1&sub_module_id=5")
      .subscribe((res) => {
  ...
  editOption(initiation) {
    ...
    this.global_psr1 = initiation['sub_module'][4]['section']
...
projecid:any;
  onSubmit(type='') {
    ...
    var url;
    if(type=="add"){
      this.transaction = this.concept_design;
    ...
    console.log(this.transaction, url)
     ...
     //if (this.editForm.valid) {
      ...
      console.log(this.concept_design,"YYYYYYYYYy")
      this.api
        .postAPI(
...
numberOnly(event:any): boolean {
  ...
  genInitiationTemplate() {
    ...
    //     //this.input_sr=res.data[3]['section'];
    //     this.concept_design=res.data[4]['section'];
    //     //this.incorporation=res.data[5]['section'];
    //     //this.rfi=res.data[6]['section'];

    //     //console.log(this.approach_paper_form,"WWWWWWWWWWW");
    //   });
   }
